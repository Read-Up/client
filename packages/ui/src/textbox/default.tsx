...
const textBoxVariants = cva(
  'w-full p-2 text-on_primary transition focus:outline-none focus:ring-none',
  {
    variants: {
      variant: {
        ...
        questionbox: 'h-40 focus:border-primary focus:ring-primary p-3  resize-none placeholder-[white-space:pre-wrap] placeholder-primary_variant',
...
const formVariants = cva(
  'w-full flex items-center rounded-[6px] bg-surface',
  {
    variants: {
      variant: {
