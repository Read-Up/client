...
const ButtonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-[6px] text-lg font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 transition duration-150 ease-in-out active:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] leading-normal',
  {
    variants: {
      variant: {
      ...
      size: {
        default: 'px-5 h-[45px]',
        sm: 'h-6 px-3',
        supporting: 'h-6 px-3 rounded-full',
        lg: 'h-[45px] w-[343px]',
        full: 'h-[45px] w-full',
        icon: 'h-[45px] w-[45px]',
        icon_small: 'h-5 w-5',
