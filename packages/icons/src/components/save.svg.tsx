...
const SaveSVG = forwardRef<SVGSVGElement, IconProps>(
  ({ className, size = "md", viewBox = "0 0 32 32", stroke = "#FFF", fill = "#FFF", ...rest }, ref) => {
    return (
      <svg
      ...
      >
        ...
        <g id="Page-1" stroke={stroke} strokeWidth="1" fill={fill} fillRule="evenodd">
          <g id="Icon-Set" transform="translate(-152.000000, -515.000000)" fill={fill}>
            <path
