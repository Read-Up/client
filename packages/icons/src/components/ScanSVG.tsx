    ...
    return (
      ...
      >
        ...
        <path
          ...
          fill={fill}
        />
        <rect x="6" y="8" width={ICON_SIZE_MAP[size]} height={ICON_SIZE_MAP[size]} />
        <rect x="4" y="12" width={ICON_SIZE_MAP[size]} height={ICON_SIZE_MAP[size]} />
        <rect x="6" y="16" width={ICON_SIZE_MAP[size]} height={ICON_SIZE_MAP[size]} />
      </svg>
    );
  },
);
